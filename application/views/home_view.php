							...
							<div class="contact-caption clearfix">
								...
								<div class="col-md-5 contact-info text-left">
									...
									<div class="info-detail">
										...
										<ul><li><i class="fa fa-map-marker"></i><span>Address:</span>#31/9/14 2nd Floor,Tanuku,Andhra Pradesh</li></ul>
										<ul><li><i class="fa fa-phone"></i><span>Phone:</span> (+91) 9494282594</li></ul>
										<!--<ul><li><i class="fa fa-fax"></i><span>Fax:</span> (01) 999-1234</li></ul>-->
										<ul><li><i class="fa fa-envelope"></i><span>Email:</span> info@vasukisolutions.in</li></ul>
									</div>
								</div>
